...
Returns `201 Created` with the saved message in the body and a `Location` header pointing to `/messages/{id}`.
...
| sentiment   | Sentiment or null | no     | One of: HAPPY, SAD, ANGRY, etc.  |
